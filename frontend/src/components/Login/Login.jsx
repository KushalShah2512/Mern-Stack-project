...
const Login = () => {
    ...
    style={{ backgroundImage: "url('https://static.vecteezy.com/system/resources/thumbnails/054/451/510/small_2x/a-blue-sky-with-a-white-cloud-in-the-background-free-photo.jpg')" }} 
>
                ...
                <div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                    <form className='space-y-6' onSubmit={handleSubmit} >
                        ...
                        <div className={`${styles.normalFlex} w-full`} >
                            ...
                            <Link to="/sign-up" className="text-red-600 pl-2">
                                Sign Up
                            </Link>
                        </div>
                    </form>
